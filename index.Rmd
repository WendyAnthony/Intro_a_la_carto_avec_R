...
## Mener des analyses reproductibles {.tabset .tabset-fade .tabset-pills}
...
## Unifier les chaînes de traitement de l'information spatiale{.tabset .tabset-fade .tabset-pills}
...
```{r lissmap, echo = TRUE, eval = TRUE, cache=TRUE, message=FALSE, warning=FALSE }
# set margins
...
Code / Slides  
https://github.com/rCarto/Intro_a_la_carto_avec_R/  
